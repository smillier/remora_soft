...
var Timer_sys,
      ...
      function timestampToHuman(seconds) {
        ...
        if (seconds < 2) {
          ...
          time = '1 minute and ' + seconds % 60 + ' seconds ago';
        } else if (seconds < 3600) {
          time = Math.floor(seconds / 60) + ' minutes and ' + (seconds % 60) + ' seconds ago';
        } else if (seconds < 7200) {
          seconds = seconds % 3600;
          var minutes = Math.floor(seconds / 60);
          seconds = seconds % 60;
          time = '1 hour ' + minutes + ' minutes and ' + seconds + ' seconds ago';
          ...
          seconds = seconds % 60;
          time = hours + ' hours ' + minutes + ' minutes and ' + seconds + ' seconds ago';
      ...
      $(document).ready(function() {
        ...
        $('a[data-toggle=\"tab\"]').on('shown.bs.tab', function (e) {
          ...
          if (target == '#tab_tinfo')  {
            ...
            $('body').addClass('loaded');
              $('#tab_fp .all .actions').click(function(e) {
                e.stopPropagation();
                e.preventDefault();
                var $this = $(this);
                if ($this.hasClass('conf')) {
